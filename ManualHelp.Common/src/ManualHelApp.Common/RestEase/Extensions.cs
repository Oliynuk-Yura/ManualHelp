...
using ManualHelp.Common.Consul;
using ManualHelp.Common.Extension;
using ManualHelp.Common.Fabio;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Options;
using RestEase;

namespace ManualHelp.Common.RestEase
{
    public static class Extensions
    {
        ...
        private static RestEaseOptions ConfigureOptions(IServiceCollection services)
        {
            ...
            services.Configure<RestEaseOptions>(options => configuration.GetSection("restEase"));
