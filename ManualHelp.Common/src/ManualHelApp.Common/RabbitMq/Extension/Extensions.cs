...
using ManualHelp.Common.Handlers.Implementation;
using ManualHelp.Common.Jaeger;
...
namespace ManualHelp.Common.RabbitMq.Extension
{
    public static class Extensions
    {
        ...
        {
           var c = builder.Register(context =>
            {
            ...
            builder.RegisterType<BusPublisher>().As<IBusPublisher>()
                .InstancePerDependency();
            builder.RegisterInstance(ManualHelpDefaultTracer.Create()).As<ITracer>().SingleInstance()
